...
className="w-full rounded-md border border-amber-200 bg-white p-2 text-sm shadow-sm transition focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-300"
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          type="submit"
className="rounded-md bg-amber-600 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-amber-700 hover:shadow-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 disabled:opacity-50"
          disabled={saving}
        >
...
{message && <div className="text-sm text-amber-700 animate-fade-in">{message}</div>}
    </form>
  );
}
